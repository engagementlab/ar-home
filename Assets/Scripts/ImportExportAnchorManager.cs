...
public class ImportExportAnchorManager : Singleton<ImportExportAnchorManager>
{
    ...
    /// </summary>
    HoloToolkit.Sharing.RoomManager roomManager;
    ...
    /// </summary>
    HoloToolkit.Sharing.RoomManagerAdapter roomManagerCallbacks;
    ...
    public void ExportComplete(SerializationCompletionReason status)
    {
        if (status == SerializationCompletionReason.Succeeded && exportingAnchorBytes.Count > minTrustworthySerializedAnchorDataSize)
        {
            ...
            roomManager.UploadAnchor(
                currentRoom,
                new HoloToolkit.Sharing.XString(exportingAnchorName), 
